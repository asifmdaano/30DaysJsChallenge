...
- **Task 5:** Add a keydown event listener to an input field that logs the key pressed too the console.
- **Task 6:** Add a keyup event listener to an input field that displays the current value in a paragraph.

  
#### Activity 4: Form Events
- **Task 7:** Add a submit event listener to a form that prevents the default submission and logs the form data to the console.
- **Task 8:** add a change listener to a select dropdown that displays the selected value in a paragraph.
 
#### Activity 5: Event Delegation

- **Task 9:** Add a event listener to a list that logs the text content of the clicked list item using event delegation.
